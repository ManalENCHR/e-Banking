...
import org.grp.ebankingbackend.daos.*;
...
public class BankAccountRestAPI {
    ...
    public List<BankAccountDTO> listAccountsByCustomer(@PathVariable String customerId){
        return bankAccountService.listBankAccountByCustomer(customerId);
    }
